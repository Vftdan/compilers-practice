...
syn match ftUNTERMINATED_STRING_LITERAL /\v((\')(((\\)([btnfr\"\'\\]|(u[0-9a-fA-F]{1,4})|\_.|))|[^\'\r\n\\]){0,})/ contains=ftUSQuoteLiteral
syn match ftSTRING_LITERAL /\v((\')(((\\)([btnfr\"\'\\]|(u[0-9a-fA-F]{1,4})|\_.|))|([^\'\r\n\\])){0,}(\'))/ contains=ftSQuoteLiteral
...
syn match ftEsc /\v\\/ contained transparent
...
syn match ftUSQuoteLiteral /\v(\')(((\\)([btnfr\"\'\\]|(u[0-9a-fA-F]{1,4})|\_.|))|[^\'\r\n\\]){0,}/ contained contains=ftEscSeq,ftSQuote
syn match ftDQuoteLiteral /\v(\")(((\\)([btnfr\"\'\\]|(u[0-9a-fA-F]{1,4})|\_.|))|[^\"\r\n\\]){0,}(\")/ contained contains=ftEscSeq,ftDQuote
syn match ftSQuoteLiteral /\v(\')(((\\)([btnfr\"\'\\]|(u[0-9a-fA-F]{1,4})|\_.|))|([^\'\r\n\\])){0,}(\')/ contained contains=ftEscSeq,ftSQuote
syn match ftCharLiteral /\v(\')(((\\)([btnfr\"\'\\]|(u[0-9a-fA-F]{1,4})|\_.|))|[^\'\r\n\\])(\')/ contained contains=ftEscSeq,ftSQuote
syn match ftBoolLiteral /\vtrue|false/ contained
syn match ftDecDigit /\v[0-9]/ contained
syn match ftHexDigit /\v[0-9a-fA-F]/ contained transparent
syn match ftDecimalNumeral /\v0|[1-9]([0-9]){0,}/ contained contains=ftDecDigit
syn match ftUnicodeEsc /\vu[0-9a-fA-F]{1,4}/ contained contains=ftHexDigit transparent
syn match ftEscAny /\v(\\)\_./ contained contains=ftEsc
syn match ftEscSeq /\v(\\)([btnfr\"\'\\]|(u[0-9a-fA-F]{1,4})|\_.|)/ contained contains=ftEsc,ftUnicodeEsc
